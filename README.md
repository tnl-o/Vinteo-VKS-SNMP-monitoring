...
![Конфигурация для мониторинга Vinteo VCS через SNMP Exporter, Prometheus и Grafana.](https://github.com/tnl-o/Vinteo-VKS-SNMP-monitoring/blob/main/2025-12-15_15-24.png)
## Структура проекта
